...
class TestApplyDeepEP:
    ...
    @patch("torch.cuda.get_device_properties")
    @patch("megatron.bridge.training.deepep.logger")
    def test_apply_flex_dispatcher_backend_warns_for_unsupported_gpu_volta(self, mock_logger, mock_get_device_properties):
    ...
    @patch("torch.cuda.get_device_properties")
    @patch("megatron.bridge.training.deepep.logger")
    def test_apply_flex_dispatcher_backend_warns_for_unsupported_gpu_pascal(self, mock_logger, mock_get_device_properties):
