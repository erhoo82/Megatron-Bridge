...
from megatron.bridge.training.deepep import apply_flex_dispatcher_backend, validate_flex_dispatcher_backend
...
class TestValidateDeepEP:
    ...
    @patch("torch.cuda.get_device_properties")
    def test_validate_flex_dispatcher_disabled_no_validation(self, mock_get_device_properties):
...
class TestApplyHybridEP:
    ...
    @patch("torch.cuda.get_device_properties")
    def test_apply_hybridep_sets_configs_for_moe_model_on_gb200(self, mock_get_device_properties):
        """Test that apply_flex_dispatcher_backend sets DeepEP configs for MoE models on GB200 GPUs."""
        # Mock Ampere GPU (compute capability 8.x)
        mock_properties = MagicMock()
...
class TestValidateHybridEP:
    ...
    @patch("torch.cuda.get_device_properties")
    def test_validate_hybridep_gb200_gpu_no_error(self, mock_get_device_properties):
    ...
    @patch("torch.cuda.get_device_properties")
    def test_validate_hybridep_future_gpu_raises_error(self, mock_get_device_properties):
        """Test that validate_flex_dispatcher_backend raises ValueError on non GB200 or GB300 GPUs when HybridEP is enabled."""
        # Mock future GPU
        mock_properties = MagicMock()
        mock_properties.major = 10
